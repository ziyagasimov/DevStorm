...
const MentorDashboard = () => {
  ...
  const [form, setForm] = useState<MentorProfile>({
    first_name: "", last_name: "", email: "", experience: "", expertise_area: "",
    years_of_experience: 0, description: "", photo_url: null,
  });
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center"><Users size={20} className="text-primary" /></div>
            <div>
              <h1 className="text-2xl font-semibold text-foreground">Mentor Paneli</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="md:col-span-1">
            <CardContent className="pt-6 flex flex-col items-center text-center">
              ...
              <p className="text-sm text-muted-foreground">{profile?.expertise_area}</p>
